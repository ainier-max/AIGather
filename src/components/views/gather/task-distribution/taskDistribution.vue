<template>
  <div style="height: 100%;overflow:hidden">
    ...
    <div style="margin:40px 50px;width: 58%;float: right;height: 80%;padding-right:20px;overflow-y: auto">
      ...
      <el-table :data="distributionUserData" stripe style="width: 100%">
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template slot-scope="scope">
            <i class="el-icon-delete" style="color:red;cursor:pointer" @click="deleteTaskDistribution(scope.row)"></i>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="未被授权用户" :visible.sync="allUserDialogVisible" :close-on-click-modal="false"
      ref="allUserDialogVisibleRef" width="30%">

      <el-table :data="allUserData" stripe style="width: 100%">
        <el-table-column prop="USERID" label="用户ID">
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            <i class="el-icon-plus" style="color:blue;cursor:pointer" @click="gatherTaskDistribution(scope.row)"></i>
          </template>
        </el-table-column>
